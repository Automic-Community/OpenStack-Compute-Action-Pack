...
/**
 * CertificatesManagement holds certificates for connecting to an HTTPS-secured Openstack instance with client/server
 * authentication.
 */
public class CertificatesManagement {
    ...
    CertificatesManagement(String keyStoreLoc, String password) throws AutomicException {
        try {
            ...
            throw new AutomicException(ExceptionConstants.SSLCONTEXT_ERROR + e.getMessage());
        }
    }
    ...
    private KeyStore getKeyStore(String keyStoreName, String password) throws IOException, AutomicException {
        ...
        try (FileInputStream fis = new java.io.FileInputStream(keyStoreName)) {
            ...
            throw new AutomicException(ExceptionConstants.INVALID_KEYSTORE);
        }
        return ks;
    }

    /**
     * Method to get the instance of {@link SSLContext} for openstack connection
     *
     * @return
     */
